...
from pleiades.portlet.flickr import exampleportlet

from pleiades.portlet.flickr.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(
            IPortletType,
            name='pleiades.portlet.flickr.ExamplePortlet')
        self.assertEquals(portlet.addview,
                          'pleiades.portlet.flickr.ExamplePortlet')
